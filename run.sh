...
while true; do
  "$WORKER" --name "$WORKER_NAME" --threads-per-card="$THREADS_PER_CARD" --label=workers --pubkey=3bfNk9C3iT8VFT1hjg1w8hwASXXaL1HcyKsQCR8t7H8Xnp25My2s1oYhs6XwtKk9D8Ku2fvbnAC7yx7Xfse65a1atCQJmMG62S1tkJkgzJuJpKXQUA8ELX5ifCevEcv7iHGb
  EXIT_CODE=$?
